...
status=0
for check in math_check synth_release_check mod_check chorus_check crash_check eq_check limiter_check inst_eq_check sample_play_check synth_engines_check macro_check hyper_saw_check engine_room_check; do
  echo "== $check"
