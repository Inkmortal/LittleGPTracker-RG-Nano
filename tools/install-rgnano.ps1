...
foreach ($check in @("math_check.cpp", "synth_release_check.cpp", "mod_check.cpp", "chorus_check.cpp", "crash_check.cpp", "eq_check.cpp", "limiter_check.cpp", "inst_eq_check.cpp", "sample_play_check.cpp", "macro_check.cpp")) {
