...
foreach ($check in @("math_check.cpp", "synth_release_check.cpp", "mod_check.cpp", "chorus_check.cpp", "crash_check.cpp", "eq_check.cpp", "limiter_check.cpp", "inst_eq_check.cpp", "sample_play_check.cpp", "synth_engines_check.cpp", "macro_check.cpp", "hyper_saw_check.cpp", "engine_room_check.cpp")) {
